...
const pixelsToDecimal = pixels =>
    parseInt(pixels.join('').replace(/\./gm, '0').replace(/#/gm, '1'), 2)
...
const outOfBoundsFill = (enhancement, numTimesEnhanced) =>
                numTimesEnhanced % 2 === 0 ? '.' : enhancement[0]
...
console.log(draw(enhanceImageMultipleTimes(image, enhancement, 2)))

const imagen = enhanceImageMultipleTimes(image, enhancement, 1)
console.log(draw(enhanceImageMultipleTimes(imagen, enhancement, 1)))
console.log('Part 9 =', countLitPixels(enhanceImageMultipleTimes(imagen, enhancement, 1)))
